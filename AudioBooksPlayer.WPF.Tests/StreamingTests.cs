    ...
    public class StreamingTests
    {
        ...
        public async Task BaseUdpStreaming()
        {
            ...
            var rstream = File.Open(
                ...
                tasks.Add(udp.StartSendStream(rstream, new IPEndPoint(IPAddress.Parse("255.255.255.255"), 23230), new Progress<StreamProgress>(Handler)).ContinueWith((state)=>rstream.Close()));
